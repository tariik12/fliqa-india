...
const PhotoGraphy = () => {
    return (
        <div style={{backgroundImage: `url("https://i.ibb.co/hZhchbY/Rectangle-217-1.png")`}} className="bg-cover bg-no-repeat border">
            <div className="grid grid-cols-2  ps-80 pt-28 pb-28 pe-40 " >
           <div className=" ">
